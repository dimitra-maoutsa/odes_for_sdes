# -*- coding: utf-8 -*-
"""
Created on Sun May 24 02:30:12 2020
...
Nstart = {1:100,2:100,3:400,4:400,5:175000}
run_id = 5
trials = 20#20
h = 0.001
t_start = 0
...
Ns = np.arange(Ns_start,550000,5000)    
                            ...
                            for ss,N3 in enumerate(Ns3):
                                if flags3[i] ==0:
                                    ...
                                    if np.mean(kll)<thr:
                                        ...
                                        filenm = 'Comp_complexity_particle_numberStoch_OU%d_trial_%d'%(run_id, i)
...
#filenm = 'Comp_complexity_particle_number_OU_Stoch%d'%run_id
#
#Dic = dict()
#Dic['Ns'] = Ns
#Dic['dim'] = dim
