# -*- coding: utf-8 -*-
"""
Created on Thu May 28 13:50:35 2020
...
Nstart = {1:100,2:100,3:100,4:400,5:24000}
run_id = 1
                ...
                for ss,N2 in enumerate(Ns2):
                    if flags2[i] ==0:
                        ...
                        if np.std(kll)<thr:
                            flags2[i] = 1
                            N_star[i] = N2
                            Ns3 = np.arange(max(100,N2-100),N2+10,10)
                            ...
                            for ss,N3 in enumerate(Ns3):
                                if flags3[i] ==0:
                                    ...
                                    if np.std(kll)<thr:
                                        ...
                                        filenm = 'Comp_complexity_particle_number_MEAN_FLUCTUATIONS_OU%d_trial_%d'%(run_id, i)
                                        ...
                                        joblib.dump(Dic, filename= filenm)
